...
#nrows = 10000  #测试代码用
nrows = None
data1=pd.read_csv('dataset/competition_train.txt',sep='\t',usecols=all_colname, nrows=nrows)

data1['true_value']=data1.returnvalue+data1.price_deduct
#print data1.shape

data2=pd.read_csv('data/features6-18/train_newFeatures43.csv',nrows=nrows)
#print data2.shape
...
File_Name = "train_feature_add3.csv"
