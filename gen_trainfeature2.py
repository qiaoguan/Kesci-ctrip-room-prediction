...
all_colname=['orderid','uid','orderdate','hotelid','basicroomid','roomid','orderlabel','star','rank','returnvalue','price_deduct','basic_minarea','basic_maxarea',\
...
#data=data[(data.orderdate_lastord<=data.orderdate)&(data.user_avgadvanceddate>=0)]  #filter some unnormal data  (filter 22037 samples, 688 of which label are 1)
...
## add some features which reflect price and user tendency
